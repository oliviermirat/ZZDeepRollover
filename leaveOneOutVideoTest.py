...
for idx, video in enumerate(videos):
  ...
  validationVideo = 1
  [normalClassedAsRollo, totalTrueNormal, rolloClassedAsRollo, totalTrueRollo] = detectRolloverFramesWithNewZZversion(testingVid, pathToRawVideos + '/', medianRollingMean, recenterImageWindow, 1, validationVideo, os.path.join(os.path.join(pathToRawVideos, testingVid), testingVid + '.avi'), imagesToClassifyHalfDiameter)
